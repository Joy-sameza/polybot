...
import { signOrder, signClobAuth } from '../crypto/eip712-signer';
...
describe('EIP-712 signer', () => {
  ...
  it('signOrder matches official test vector', async () => {
  ...
  it('signClobAuth matches official test vector', async () => {
    const sig = await signClobAuth(wallet, 80002, 10_000_000, 23);
